...
function WPPortfolio_pages_showDocumentation() 
{
	...
	echo '<ul class="wp-group-syntax">';
		echo '<li>'.sprintf(__('To order websites by the date they were added, showing newest first (so descending order) use %s. Group names are automatically hidden when ordering by date.', 'wp-portfolio'), '<code><b>[wp-portfolio ordertype="dateadded" orderby="desc"]</b></code>').'</li>';
		echo '<li>'.sprintf(__('To order websites by the date they were added, showing oldest first (so ascending order) use %s. Group names are automatically hidden when ordering by date.', 'wp-portfolio'), '<code><b>[wp-portfolio ordertype="dateadded" orderby="asc"]</b></code>').'</li>';
	echo '</ul>';
